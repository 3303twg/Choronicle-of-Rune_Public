...
public class CrateController : NPCController
{
    ...
    public void OnItemSelected(int index)
    {
        ...
        if (!CollectorManager.Instance.itemDataDic.ContainsKey(selectedItem.displayName))
            CollectorManager.Instance.itemDataDic.Add(selectedItem.displayName, selectedItem);
